        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id==R.id.home){
                    ...
                    getSupportFragmentManager().beginTransaction().replace(R.id.container, RecFragment.class,null ).addToBackStack(null).commit();


                }else if (id==R.id.setting){
                    getSupportFragmentManager().beginTransaction().replace(R.id.container, SettingFragment.class,null ).addToBackStack(null).commit();
